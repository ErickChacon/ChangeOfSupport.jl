...
function sample_model_standard_fixsigma(y, x, Bw, Bvx, Bvy, Pw, Pv, κw, id; binit = nothing, βinit = nothing,
    σ²yinit = nothing, σ²xinit = nothing, κwinit = nothing, κvinit = nothing, δwinit = nothing, δvinit = nothing,
    nsamples = 10, burnin = 0, thin = 1, thinz = 1)
    ...
    Dict("w" => δw_samples, "v" => δv_samples, "beta" => βf_samples,
        "sigma2_y" => σ²y_samples, "sigma2_x" => σ²x_samples, "κappaw" => κw_samples, "kappav" => κv_samples, "z" => z_samples)
end
